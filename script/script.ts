...
class Cat extends Animal {
    ...
    fur: string;
    urlBreed: string;
    constructor(name: string, age: number, gender: string, size: string, vaccine: boolean, img: string, breed: string, fur: string, urlBreed: string){
...
class Dog extends Animal {
    breedDog: string;
    training: string;
    constructor(name: string, age: number, gender: string, size: string, vaccine: boolean, img: string, breedDog: string, training: string) {
        super(name, age, gender, size, vaccine, img)
